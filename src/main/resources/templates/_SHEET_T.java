...
public class _SHEET_T {
  ...
  public List<_TABLE_RECORD_T> get_TABLE() {
    ...
    for (int i = _FIRST_ROW; true; i++) {
      ...
      if (ExcelReader.isEmptyRowPart(row, _FIRST_COL, _LAST_COL)) break;
      else records.add(new _TABLE_RECORD_T(row, _FIRST_COL, _LAST_COL));
    }
    return records;
  }
  ...
  public List<_FREE_POSITION_TABLE_RECORD_T> get_FREE_POSITION_TABLE() {
    Optional<Coordinates> coord =
        ExcelReader.find(Entity.FREE_POSITION_TABLE, "_TABLE_NAME", sheet);
    ...
    for (int i = firstRowNum; true; i++) {
      ...
      else records.add(new _FREE_POSITION_TABLE_RECORD_T(row, firstColNum, lastColNum));
    }
    return records;
  }
  ...
  public _FREE_POSITION_TABLE_RECORD_T addRecordIn_FREE_POSITION_TABLE() {
    ...
    return new _FREE_POSITION_TABLE_RECORD_T(
